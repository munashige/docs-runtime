...
Руководство по установке платформы VITACORE доступно в документации по [этой ссылке](https://drive.google.com/file/d/1fxfn0LoQHp54wtgxjSnMeovps8gtttAD/view). Здесь можно найти подробные шаги по установке и настройке платформы на вашем компьютере.
