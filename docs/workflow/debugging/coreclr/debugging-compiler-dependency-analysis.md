...
Техника анализа заключается в том, чтобы определить, какая нода отсутствует в графе или ошибочно присутствует в графике. Далее нужно изменить логику анализа зависимостей для корректировки графика. Эта глава описывает различные способы отладки для выявления ошибок.
