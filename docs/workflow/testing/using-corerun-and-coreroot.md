...
__ПРИМЕЧАНИЕ__: Для генерации Core_Root вы также должны собрать библиотеки заранее с помощью -subset libs. По умолчанию скрипт сборки тестов ищет библиотеки в конфигурации Release, независимо от конфигурации runtime, которую вы указали. Если вы собрали библиотеки в другой конфигурации, то вам нужно передать соответствующий флаг /p:LibrariesConfiguration=<ваша_конфигурация>. Подробнее см. в [документации по тестированию CoreCLR](/docs/workflow/testing/coreclr/testing.md).
